        ...
        <div class="auth-box p-4 bg-white rounded">
          <div>
            <div class="logo text-center">
              ...
              /></span>
              <h5 class="font-weight-medium mb-3 mt-1">Add User</h5>
            </div>
            <!-- Form -->
            <div class="row mt-4">
              <div class="col-12">
                ...
                <form action="{{ route('useradd') }}" method="Post" enctype="multipart/form-data">
                  ...
                  <div class="form-floating mb-3">
                    ...
                    <label for="tb-rnumber">Number</label>
                    <div class="invalid-feedback">Number is required</div>
                  </div>  
                  <div class="form-floating mb-3">
                    <input type="file" value="" class="form-control form-input-bg @error('profile_image') is-invalid @enderror" name="profile_image" id="profile_image" placeholder="image" required
                    />
                    @error('profile_image')
                  ...
                  <div class="d-flex align-items-stretch">
                    ...
                    <button type="submit" class="btn btn-info d-block w-100">Add User</button>
