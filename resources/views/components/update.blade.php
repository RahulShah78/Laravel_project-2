      ...
      >
        <div class="auth-box on-sidebar p-4 bg-white m-0 rounded">
          <div>
            ...
            <h3 class="box-title mt-5 mb-0">Update Now</h3>
            <small class="text-muted">Update account and enjoy</small>
            <!-- Form -->
            <div class="row mt-4">
              <div class="col-12">
                <form class="form-horizontal" action="/trytoupdate/{{$user->id}}" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-floating mb-3">
                    <input
                      ...
                      class="form-control form-input-bg"
                      id="tb-remail"
                      mailto:placeholder="john@gmail.com"
                      required
                      name="email"
                      value="{{$user->email}}"
                    />
                  ...
                  <div class="form-floating mb-3">
                    <input
                      ...
                      value="{{$user->Role}}"
                    />
                    <label for="tb-remail">Role</label>
                  ...
                  <div class="form-floating mb-3">
                    <input
                      ...
                      value="{{$user->number}}"
                    />
                    <label for="tb-remail">Number</label>
