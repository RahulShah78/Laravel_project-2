            ...
            <div class="card-body">
                <form action="{{ route('role.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        <label for="RoleGroup">Select User Type</label>
                        <select class="form-control" id="RoleGroup" name="User_Type" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="Role" name="Role_Name" placeholder="Enter Role name" required>
                    </div>
                    <div class="form-group">
